  ...
  linear_search_issues: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        orderBy: {
          type: 'string',
          description: 'Field to order by. Supported values: createdAt, updatedAt. Default: updatedAt. Note: Cannot sort by priority - use priority filter instead.',
          optional: true,
  ...
  linear_search_project_milestones: {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        orderBy: {
          type: 'string',
          description: 'Field to order by. Supported values: createdAt, updatedAt. Default: updatedAt.',
          optional: true,
          enum: ['createdAt', 'updatedAt'],
          default: 'updatedAt',
        },
